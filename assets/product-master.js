(function () {
  ...
  async function updateMaster(payload, password) {
  ...
  function passwordField(id) {
    return '<div class="product-master-field"><label for="' + id + '">Senha de publicação</label><input id="' + id +
      '" type="password" value="152535" autocomplete="current-password"></div>';
  }
  ...
  function renderCategories() {
    ...
    categoriesContainer.innerHTML = '<div class="product-master-page">' +
      ...
      passwordField('categoryPassword') + '<button class="product-master-button" type="submit">Cadastrar categoria</button></form></section>' +
  ...
  function renderSkus() {
    ...
    skuContainer.innerHTML = '<div class="product-master-page"><section class="product-master-toolbar"><div class="product-master-title">' +
      ...
      passwordField('skuPassword') + '</div></section><div class="product-master-status" id="skuStatus"></div>' +
      ...
      select.addEventListener('change', async function () {
        ...
        try {
          await updateMaster({ action: 'assign-sku', sku: this.dataset.sku, categoryId: this.value },
            document.getElementById('skuPassword').value);
          renderSkus();
